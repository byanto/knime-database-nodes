...
abstract class AbstractTablePanel extends JPanel {
    ...
    protected void setEnabledAddButton(final boolean isEnabled) {
        m_addButton.setEnabled(isEnabled);
    }

    protected void setEnabledRemoveButton(final boolean isEnabled) {
     ...
     */
    protected abstract void createTablePopupMenu(JPopupMenu menu);
     ...
     */
    protected abstract void createNoRowSelectedMenu(JPopupMenu menu);
