...
public class KeysPanel extends AbstractTablePanel {
    ...
    private void createSelectKeysContain(final JPopupMenu menu) {
        ...
        Map<String, List<Integer>> columnKeyIdxMapping = new TreeMap<String, List<Integer>>();
        for (int i = 0; i < getTableModel().getRowCount(); i++) {
    ...
    private class ColumnsDialog extends JDialog {
        ...
        private ColumnsDialog(final Window parent, final int rowIdx) {
            ...
            m_rowIdx = rowIdx;
            m_listModel = new DefaultListModel<ColumnElement>();
            List<RowElement> colElems = new ArrayList<RowElement>(
            ...
            m_list = new JList<ColumnElement>(m_listModel);
        ...
        private void onOK() {
            Set<ColumnElement> selectedColumns = new HashSet<ColumnElement>(m_list.getSelectedValuesList());
